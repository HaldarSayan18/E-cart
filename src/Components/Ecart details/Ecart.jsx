        ...
        <>
            ...
            <div className='container mt-3'>
                <Row style={{ display: "flex", alignItems: "center", justifyContect: "center", width: "auto" }}>
                    <h1 className='text-center' style={{ marginBottom: "30px", border: "1px solid purple", borderRadius: "10px" }}>Items Add to Cart</h1>
                    {data.map((ele, id) => (
                        <Col key={id}>
                            <Card className='card-details' style={cardStyle} onMouseEnter={() => setIsHovered(true)}
                                onMouseLeave={() => setIsHovered(false)}>
                                <Card.Img variant="top" src={ele.imgdata} style={{ width: '25.1rem', height: '20rem', margin: "5px", cursor: "pointer", borderRadius: "0px", border: "none" }} />
                                <Card.Body >
                                    ...
                                    <Button variant="primary"><Link to={`/details?id=${ele.id}`} style={{ textDecoration: "none", color: "white" }}> Know more </Link></Button>
